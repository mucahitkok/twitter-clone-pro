...
const Svg = ({ children, className }) => {
    return (
        <svg viewBox="0 0 24 24" className={`cursor-pointer fill-current ${className}`}>
            {children}
        </svg>
    )
}

export const TwitterLogoIcon = ({ className }) => {
    return (
...
export const ListsIcon = ({ className }) => {
    return (
        <Svg className={className} >
            <path d="M19.75 22H4.25C3.01 22 2 20.99 2 19.75V4.25C2 3.01 3.01 2 4.25 2h15.5C20.99 2 22 3.01 22 4.25v15.5c0 1.24-1.01 2.25-2.25 2.25zM4.25 3.5a.75.75 0 0 0-.75.75v15.5c0 .413.336.75.75.75h15.5a.75.75 0 0 0 .75-.75V4.25a.75.75 0 0 0-.75-.75H4.25z" /><path d="M17 8.64H7a.75.75 0 0 1 0-1.5h10a.75.75 0 1 1 0 1.5zm0 4.11H7a.75.75 0 0 1 0-1.5h10a.75.75 0 0 1 0 1.5zm-5 4.11H7a.75.75 0 1 1 0-1.5h5a.75.75 0 0 1 0 1.5z" />
        </Svg>
    )
}
...
export const MoreIcon = ({ className }) => {
    return (
        <Svg className={className} >
            <circle cx="17" cy="12" r="1.5" /><circle cx="12" cy="12" r="1.5" /><circle cx="7" cy="12" r="1.5" /><path d="M12 22.75C6.072 22.75 1.25 17.928 1.25 12S6.072 1.25 12 1.25 22.75 6.072 22.75 12 17.928 22.75 12 22.75zm0-20C6.9 2.75 2.75 6.9 2.75 12S6.9 21.25 12 21.25s9.25-4.15 9.25-9.25S17.1 2.75 12 2.75z" />
        </Svg>
    )
}
...
export const GifIcon = ({ className }) => {
    return (
        <Svg className={className} >
            <path d="M19 10.5V8.8h-4.4v6.4h1.7v-2h2v-1.7h-2v-1H19zm-7.3-1.7h1.7v6.4h-1.7V8.8zm-3.6 1.6c.4 0 .9.2 1.2.5l1.2-1C9.9 9.2 9 8.8 8.1 8.8c-1.8 0-3.2 1.4-3.2 3.2s1.4 3.2 3.2 3.2c1 0 1.8-.4 2.4-1.1v-2.5H7.7v1.2h1.2v.6c-.2.1-.5.2-.8.2-.9 0-1.6-.7-1.6-1.6 0-.8.7-1.6 1.6-1.6z" /><path d="M20.5 2.02h-17a2.25 2.25 0 0 0-2.25 2.247v15.507A2.251 2.251 0 0 0 3.5 22.02h17c1.24 0 2.25-1.008 2.25-2.246V4.267A2.25 2.25 0 0 0 20.5 2.02zm.75 17.754a.75.75 0 0 1-.75.746h-17a.75.75 0 0 1-.75-.746V4.267c0-.412.336-.747.75-.747h17c.414 0 .75.335.75.747v15.507z" />
        </Svg>
    )
}

export const PollIcon = ({ className }) => { // Anket
    return (
        <Svg className={className} >
...
export const ShareIcon = ({ className }) => {
    return (
        <Svg className={className} >
            <path d="m17.53 7.47-5-5a.749.749 0 0 0-1.06 0l-5 5a.749.749 0 1 0 1.06 1.06l3.72-3.72V15a.75.75 0 0 0 1.5 0V4.81l3.72 3.72c.146.147.338.22.53.22s.384-.072.53-.22a.749.749 0 0 0 0-1.06z" /><path d="M19.708 21.944H4.292A2.294 2.294 0 0 1 2 19.652V14a.75.75 0 0 1 1.5 0v5.652c0 .437.355.792.792.792h15.416a.793.793 0 0 0 .792-.792V14a.75.75 0 0 1 1.5 0v5.652a2.294 2.294 0 0 1-2.292 2.292z" />
        </Svg>
    )
}

export const SesarchIcon = ({ className }) => {
    return (
        <Svg className={className} >
